...
@Component({
  selector: 'app-web-profile-form-step-2',
  standalone: true,
  imports: [SharedModule, NgStyle],
  templateUrl: './web-profile-form-step-2.component.html',
  styleUrl: './web-profile-form-step-2.component.scss',
})
export class WebProfileFormStep2Component {
