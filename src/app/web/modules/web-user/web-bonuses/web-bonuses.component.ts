...
@Component({
  selector: 'app-web-bonuses',
  templateUrl: './web-bonuses.component.html',
  styleUrls: ['./web-bonuses.component.scss'],
})
export class WebBonusesComponent implements OnInit, OnDestroy {
  ...
  public ngOnInit(): void {
    ...
    this.carouselService.setCarouselData(this.data, false, true, false);
  }
